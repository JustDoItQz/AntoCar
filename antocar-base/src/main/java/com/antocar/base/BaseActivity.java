...
import com.antocar.base.delegate.IActivity;
import com.antocar.integration.cache.Cache;
import com.antocar.integration.cache.CacheType;
import com.antocar.integration.lifecycle.ActivityLifecycleable;
import com.antocar.mvp.IPresenter;
...
import static com.antocar.utils.ThirdViewUtil.convertAutoView;
...
public abstract class BaseActivity<P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
     ...
     * 如果返回false,那意味着这个Activity不需要绑定Fragment,那你再在这个Activity中绑定继承于 {@link com.antocar.base.BaseFragment} 的Fragment将不起任何作用
     *
     * @return
     */
    @Override
